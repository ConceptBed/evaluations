...
if __name__=="__main__":
    ...
    for dm in domains:
        ...
        df.index = models
        df.to_csv(os.path.join(store_path, f"{dm}_all.csv"))
    ...
    df.index = models
    df.to_csv(os.path.join(store_path, f"domains_{args.gen_name}_overall.csv"))
    tex = df.to_latex()
    with open(os.path.join(store_path, f"domains_{args.gen_name}_overall.tex"), "w") as h:
        h.write(tex)
